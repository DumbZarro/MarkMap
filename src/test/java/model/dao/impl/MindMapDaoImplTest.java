...
public class MindMapDaoImplTest {
    ...
    static{
        ...
        MapNode sonNode0 = new MapNode(2,nodeService.getDefaultHeight(),nodeService.getDefaultWidth(),nodeService.getSCALE());
        MapNode sonNode1 = new MapNode(3,nodeService.getDefaultHeight(),nodeService.getDefaultWidth(),nodeService.getSCALE());
        MapNode sonNode2 = new MapNode(4,nodeService.getDefaultHeight(),nodeService.getDefaultWidth(),nodeService.getSCALE());
        MapNode gransonNode =  new MapNode(5,nodeService.getDefaultHeight(),nodeService.getDefaultWidth(),nodeService.getSCALE());
        MapNode gransonNode1 =  new MapNode(6,nodeService.getDefaultHeight(),nodeService.getDefaultWidth(),nodeService.getSCALE());
